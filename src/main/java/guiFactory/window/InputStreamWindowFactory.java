 ...
 * Beispiel:
 * <pre>{@code
 *     JFrame frame = new InputStreamWindowFactory("Mein Fenster", 1024, 768)
 *         .setCentered(true)
 ...
 * @since 2025-07-11
 */
public class InputStreamWindowFactory {
     ...
     * @since 1.0
     */
    public InputStreamWindowFactory(){}
     ...
     * @since 1.0
     */
    public InputStreamWindowFactory(String title, int width, int height) {
        this.title = title;
        this.width = width;
        this.height = height;
    }
     ...
     *
     * @param title der neue Fenstertitel
     * @return die aktuelle Instanz von {@code InputStreamWindowFactory} für Methodenverkettung
     * @since 1.0
     */
    public InputStreamWindowFactory setTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @since 1.0
     */
    public InputStreamWindowFactory setSize(int width, int height) {
        this.width = width;
        this.height = height;
        return this;
    }
     ...
     * @since 1.0
     */
    public InputStreamWindowFactory setCentered(boolean centered) {
     ...
     * @since 1.0
     */
    public InputStreamWindowFactory setCloseOperation(int closeOperation) {
     ...
     */
    public JFrame build() {
        JFrame inputStreamFrame = new JFrame(title);
        inputStreamFrame.setSize(width, height);
        inputStreamFrame.setDefaultCloseOperation(closeOperation);
        if(centered){
            inputStreamFrame.setLocationRelativeTo(null);
        }
        return inputStreamFrame;
    }
