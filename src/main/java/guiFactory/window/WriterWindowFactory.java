 ...
 * Beispiel:
 * <pre>{@code
 *     JFrame frame = new WriterWindowFactory("Mein Fenster", 1024, 768)
 *         .setCentered(true)
...
public class WriterWindowFactory {
     ...
     *
     * @param title der neue Fenstertitel
     * @return die aktuelle Instanz von {@code WriterWindowFactory} für Methodenverkettung
     * @since 1.0
     */
     ...
     *
     * @param centered das neue Schließverhalten
     * @return die aktuelle Instanz von {@code WriterWindowFactory} für Methodenverkettung
     * @since 1.0
     */
